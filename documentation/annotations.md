...
In this example, most clients can make up to 1200 requests per 10 seconds. Clients from `10.0.0.0/8` or IP `192.168.1.100` are never rate limited. When the limit is exceeded for non-whitelisted IPs, a 429 status code is returned.
